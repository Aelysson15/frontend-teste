...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button id="btn-topo" class="btn btn-outline my-2 my-sm-0" type="submit">Subscribe</button>
    </form>
  </div>
</nav>
<!-- final header -->
...
<div id="banner" class="jumbotron jumbotron-fluid">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        <img class="img-fluid" src="assets/imgs/design-img.jpg" alt="">
      </div>
      <div class="col-md-6">
        <h1 class="display-4">We focus on ergonomics</h1>
...
<section id="sessoes">
  <div id="bg" class="container-fluid text-center">
    ...
    <div id="img-proto" class="container">
      <img class="img-responsive" src="assets/imgs/proto.png" alt="">
    </div>
  </div>
</section>
